...
import RegisterBanner from '../assets/images/register_banner.avif'
...
function RegisterPage() {
    ...
    return (
        <React.Fragment>
            <Helmet>
                <title>
                    Đăng ký | Tạo tài khoản mua hàng, tích điểm đổi quà
                </title>
            </Helmet>
            ...
            <div className="bg-white h-screen">
                <div className="flex flex-col laptop:grid grid-cols-12 gap-2 h-full">
                    <div className="relative col-span-8">
                        ...
                        {/* Only show on mobile */}
                        <div className="block laptop:hidden absolute top-5 w-full container z-10">
                        ...
                        <div className="w-full h-full overflow-hidden">
                            <img
                                src={RegisterBanner}
                                alt="login banner"
                                className="w-full h-full object-cover mt-10 scale-95"
                            />
                        </div>
                    </div>

                    <div className="relative col-span-4 mt-[50px] laptop:my-auto">
                        <div className="w-[450px] mx-auto">
                            {showSignupForm && (
                                <div
                                    className="absolute -top-[20px] laptop:-top-[80px] left-[20px] p-2 rounded-full border w-fit hover:bg-wallground-light cursor-pointer transition duration-200 mb-20"
                                    onClick={() => {
                            ...
                            {!showSignupForm && (
                                <div>
                                    ...
                                    <div className="my-7 flex items-center justify-between">
                                        <div className="h-[1px] w-[calc(100%/2-50px)] bg-border" />
